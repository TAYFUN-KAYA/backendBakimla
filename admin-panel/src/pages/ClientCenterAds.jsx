...
export default function ClientCenterAds() {
  ...
  const handleImageUpload = async (file, isProductImage = false) => {
    ...
    try {
      const response = await adminService.uploadImage(file, 'client-ads');
  ...
  const handleCreateSubmit = async () => {
    ...
    try {
      ...
      await adminService.clientCenterAds.create(adData);
  ...
  const handleEditSubmit = async () => {
    ...
    try {
      ...
      await adminService.clientCenterAds.update(editModal.item._id, adData);
  ...
  return (
    <>
    <GenericModelList
      title="Müşteri Merkez Reklamları"
      service={adminService.clientCenterAds}
      columns={columns}
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500"
                  placeholder="Reklam alt başlığı..."
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500"
                    placeholder="erkek_kuafor, kadin_kuafor, guzellik_merkezi..."
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full h-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500"
                />
              </div>
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-3xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <input
                  type="text"
                  value={editModal.item.subtitle || ''}
                  onChange={(e) => setEditModal({ ...editModal, item: { ...editModal.item, subtitle: e.target.value } })}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500"
                />
              </div>
              ...
              <div>
                ...
                <input
                  type="color"
                  value={editModal.item.color || '#743DFD'}
                  onChange={(e) => setEditModal({ ...editModal, item: { ...editModal.item, color: e.target.value } })}
                  className="w-full h-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500"
                />
              </div>
