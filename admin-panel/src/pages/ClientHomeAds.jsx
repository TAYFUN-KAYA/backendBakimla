...
export default function ClientHomeAds() {
  ...
  const handleCreateSubmit = async () => {
    ...
    try {
      ...
      await adminService.clientHomeAds.create(adData);
  ...
  const handleEditSubmit = async () => {
    ...
    try {
      const adData = {
        ...
        color: editModal.item.color || '#6B25FF',
      ...
      await adminService.clientHomeAds.update(editModal.item._id, adData);
  ...
  return (
    <>
      <GenericModelList
        title="Müşteri Ana Sayfa Reklamları"
        service={adminService.clientHomeAds}
        columns={columns}
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    type="color"
                    value={editModal.item.color || '#6B25FF'}
